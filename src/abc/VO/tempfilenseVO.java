...
@Entity
@Table(name="tempfilense")

public class tempfilenseVO {

	@Id
	@Column(name="tmptradeId")
	@GeneratedValue(strategy=GenerationType.AUTO)
	private int tmptradeId;
	...
	public int getTmptradeId() {
		return tmptradeId;
	}

	public void setTmptradeId(int tmptradeId) {
		this.tmptradeId = tmptradeId;
	}
