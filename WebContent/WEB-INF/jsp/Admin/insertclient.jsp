...
<div class="container">
<h2>Upload-Client</h2>
<f:form class="form-horizontal" action="insertclient.htm" method="post" modelAttribute="data">
  <div class="form-group">
      <label class="control-label col-sm-2" for="name">Client-Name:</label>
      <div class="col-sm-10">
		<f:input path="clientCname"   />
		</div>
  </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="code">Client-Code:</label>
      <div class="col-sm-10">
		<f:input path="clientCode"  />
		</div>
  </div>
...
<h4><a href="<%=request.getContextPath()%>/modifyclient.htm">Modify Client Details</a></h4>
